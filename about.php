    ...
    <div id="about_page">
      <div class="row">
        <div class="large-12 columns">
        	<div class="panel">
                <h1>About the Card</h1><hr>
                <p>The RowanCard is the official photo identification of the University and should be carried at all times.  
                Although one card, it has three uses and gives students access to many privileges.</p>
