  ...
  <section id="merchants_page">
    <div class="row">
      <div class="large-12 column">
        <div class="panel">
          <h1 id="top-bar">Camden Merchants</h1>
          <strong>(Click on images to see more information)</strong>
          <hr>
          <div class="row">
            <div class="large-2 medium-2 columns picture">
              <a class="th" href="http://universitydistrict.bncollege.com/webapp/wcs/stores/servlet/BNCBHomePage?storeId=65132&catalogId=10001&langId=-1" target="_blank"><img src="images/merchants/on_campus/bursars.jpg"></a>
            </div>
            <div class="large-2 medium-2 columns">
              <p><strong>Barnes & Noble</strong><br>
              <em>601 Cooper Street</em><br>
              <em>Camden, NJ 08102</em><br>
              <em>(856) 968-1200</em></p>
            </div>

            <div class="large-2 medium-2 columns picture">
              <img src="images/merchants/on_campus/library.jpg">
            </div>
            <div class="large-2 medium-2 end columns">
              <p><strong>All-Stop Grocery</strong><br>
              <em>116-118 N Broadway</em><br>
              <em>Camden, NJ 08102</em><br>
              <em>(856) 338-0852</em><br>
            </div>
          </div>
        </div>
      </div>
